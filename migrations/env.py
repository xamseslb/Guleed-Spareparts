...
from backend.models.loan import Loan  # noqa: F401

# this is the Alembic Config object, which provides
# access to the values within the .ini file in use.
config = context.config

# The database URL comes from the app config (DATABASE_URL env var), so
...
# render_as_batch lets SQLite emulate ALTER TABLE (needed for schema changes).
